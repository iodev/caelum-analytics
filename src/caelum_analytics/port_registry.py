...
class PortAllocation:
    ...
    def __str__(self) -> str:
        location = (
            f" on {self.machine_id}({self.ip_address})" if self.machine_id else ""
        )
...
class CaelumPortRegistry:
    ...
    def _initialize_core_allocations(self):
        ...
        core_ports = [
            ...
            PortAllocation(
                ...
                "caelum-core",
                "Inter-cluster WebSocket communication",
            ),
            ...
            # API Gateway
            PortAllocation(
                8000, "api-gateway", ServiceType.API, "caelum-core", "Main API gateway"
            ),
            ...
            PortAllocation(
                ...
                ServiceType.MCP_SERVER,
                "caelum-business",
                "Opportunity discovery MCP server",
            ),
            PortAllocation(
                8108,
            ...
            PortAllocation(
                ...
                ServiceType.MCP_SERVER,
                "caelum-security",
                "Security management MCP server",
            ),
            PortAllocation(
                8112,
                "caelum-user-profile",
            ...
            PortAllocation(
                ...
                "Cross-device notifications MCP server",
            ),
            PortAllocation(
                8115,
                ...
                ServiceType.MCP_SERVER,
                "caelum-dev",
                "Development session MCP server",
            ),
            PortAllocation(
                8116,
    ...
    def find_available_port(
        self, start_range: int = 8400, end_range: int = 8500
    ) -> Optional[int]:
    ...
    def list_by_project(self, project: str) -> List[PortAllocation]:
        ...
        return [
            alloc for alloc in self._allocations.values() if alloc.project == project
        ]
    ...
    def assign_service_to_machine(
        self, port: int, machine_id: str, ip_address: str
    ) -> bool:
    ...
    def get_services_on_machine(self, machine_id: str) -> List[PortAllocation]:
        ...
        return [
            alloc
            for alloc in self._allocations.values()
            if alloc.machine_id == machine_id
        ]
        ...
        for machine in machine_registry.machines.values():
            for service in machine.running_services:
                self.assign_service_to_machine(
                    service["port"], machine.machine_id, machine.primary_ip
                )
